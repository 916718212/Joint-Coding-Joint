...
class PointFusion(BaseModule):
    ...
    def __init__(self,
        ...
        self.fc_try=nn.Linear(256,128)
        self.fc_try2=nn.Linear(256,128)
    ...
    def forward(self, img_feats, pts, pts_feats, img_metas):
        ...
        # fuse_pts=self.fc_try(fuse_pts)
        # fuse_img=torch.cat((img_pre,fuse_m),-1)
        # fuse_img=self.fc_try2(fuse_img)
        ...
        fuse_out = fuse_pts+fuse_img
        fuse_out=self.fc_try2(fuse_out)
        
        # print("fuse_out:",fuse_out)
